...
void FSWidget::setNewModel(QStandardItemModel *newmodel)
{
    tree->setModel(newmodel);
    model = newmodel;
}

void FSWidget::rebuildModel(QString str)
{
    curretnPath = str;
